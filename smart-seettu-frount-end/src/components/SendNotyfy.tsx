...
// // Component එකට පිටතින් ලැබෙන දත්ත (Props) ටික මෙතනින් Define කරනවා
...
//     grupId = currentGroupId;
//     setGrupId(currentGroupId);
//   }, []);

//   // Request එක යවන වෙලාවේ වැඩ කරන function එක
...
//         // මෙතනට Backend API එකට Request එක යවන Code එක දාන්න පුළුවන්
...
//               text: `Invitation has been not sent to ${user.name}.`,
//               icon: "error",
//               timer: 2000,
//               showConfirmButton: false,
//             });
...
//         onClose(); // Request එක යැව්වට පස්සේ Modal එක වහනවා
//       }
//     });
//   };

//   return (
//     // මුළු Screen එකම වැහෙන පසුබිම (Overlay Backdrop)
...
//       {/* ප්‍රධාන කාඩ්පත (Profile Card Container) */}
//       <div className="relative w-full max-w-md mx-4 bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100 transform transition-all animate-in fade-in zoom-in-95 duration-200">
//         {/* වහන්න තියෙන (Close) Button එක */}
//         <button
//           onClick={onClose}
...
//         {/* ඉහළ හැඩසවිකිරීම් කොටස (Card Header Background) */}
//         <div className="h-28 bg-gradient-to-r自动 bg-gradient-to-r from-blue-500 to-indigo-600 relative"></div>

//         {/* පරිශීලක විස්තර ඇතුළත් කොටස (Card Content) */}
...
//           {/* පණිවිඩය (Invitation Message Invitation Text) */}
...
//           {/* ක්‍රියාකාරී බොත්තම් (Action Buttons) */}
//           <div className="mt-6 flex gap-3">
//             <button
//               onClick={onClose}
//               className="flex-1 px-4 py-2.5 border border-gray-200 text-gray-700 font-medium text-sm rounded-xl hover:bg-gray-50 transition active:scale-95"
//             >
//               Cancel
//             </button>
//             <button
//               onClick={handleSendRequest}
//               className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium text-sm rounded-xl transition shadow-md shadow-blue-200 active:scale-95"
//             >
